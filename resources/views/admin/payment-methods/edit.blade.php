...
@section('title', 'Ödeme Yöntemi Düzenle - Yönetim Paneli')
@section('page-title', 'Ödeme Yöntemi Düzenle')
            ...
            <form action="{{ route('admin.payment-methods.update', $method) }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="baslik" class="form-control" value="{{ old('baslik', $method->baslik) }}" required>
                    </div>
                </div>
